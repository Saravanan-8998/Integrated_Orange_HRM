...
export class BuzzPage {
    ...
    constructor(page: Page) {
        ...
        this.buzzLocators = {
            ...
            threeDots: `(//i[@class='oxd-icon bi-three-dots'])`,
            thrash: `i.oxd-icon.bi-trash`,
            fileLocation: `//input[@class='oxd-file-input']`
        }
    ...
    async uploadFile(filePath: any) {
        await this.page.setInputFiles(this.buzzLocators.fileLocation, filePath);
    ...
    async deleteFeed() {
        await this.page.locator(this.buzzLocators.threeDots).first().click();
        await this.page.locator(this.buzzLocators.thrash).click();
