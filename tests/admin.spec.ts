...
hoursBefore.setHours(hoursBefore.getHours() - 9.30);
const germanDate = date.format(hoursBefore, 'YYYY-MM-DD');
const usDate = date.format(hoursBefore, 'DD-MM-YYYY');

let systemUsersLocators = [];
let systemUsersLocatorsValues = [Constants.Users.userNameUser2, Constants.Users.employeeNameUser2];
...
test.describe('Filling Admin Information and editing the information', () => {
    test('Searching Admin Information', async () => {
        ...
        await adminPage.selecDropdownOption(adminPage.userManagementLocators.employeeName, Constants.Users.employeeNameUser2);
        ...
        await adminPage.clickElementWithIndex(adminPage.search, 0);
        let table = await page.locator(adminPage.tableRow).textContent();
        expect(table).toBe(Constants.assertion.adminCheck);
    ...
    test('Filtering Results and Editing the Existing Information', async () => {
        ...
        await adminPage.fillTextBoxValues(adminPage.userManagementLocators.userName, Constants.Users.userNameUser2);
        await adminPage.fillTextBoxValues(adminPage.userManagementLocators.employeeName, Constants.Users.employeeNameUser2);
        await adminPage.selecDropdownOption(adminPage.userManagementLocators.employeeName, Constants.Users.employeeNameUser2);
        await adminPage.selecDropdownOption(adminPage.userManagementLocators.userRole, Constants.adminModule.userRole);
        await adminPage.selecDropdownOption(adminPage.userManagementLocators.status, Constants.adminModule.status);
        await adminPage.clickElementWithIndex(adminPage.save, 0);
    });
});
...
test.describe('Filling Job Information and editing the information', () => {
    test('Adding Job Titles Information and saving', async () => {
        ...
        await adminPage.clickSave(adminPage.save, 0, Constants.sucessMsg.sucessfulSavedMsg);
    });
...
test.describe('Filling Pay Grades and editing the information', () => {
    ...
    test('Editing the Existing Pay Grades Information by filtering', async () => {
        ...
        await adminPage.clickElementWithIndex(adminPage.add, 0);
        await page.waitForTimeout(3000);
...
test.describe('Filling Employment Status and editing the information', () => {
    ...
    test('Editing the Existing Employment Status Information by filtering', async () => {
        ...
        await adminPage.fillTextBoxValues(adminPage.empStatusLocators.empStatusName, Constants.adminModule.employeeStatusNameEdit);
        await adminPage.clickSave(adminPage.save, 0, Constants.sucessMsg.successfulUpdatedMsg);
    });
...
test.describe('Filling Job Categories and editing the information', () => {
    ...
    test('Editing the Existing Job Categories Information by filtering', async () => {
        ...
        await adminPage.fillTextBoxValues(adminPage.jobCatLocators.jobCatName, Constants.adminModule.jobCategoryEdited);
        await adminPage.clickSave(adminPage.save, 0, Constants.sucessMsg.successfulUpdatedMsg);
    });
...
test.describe('Filling Work Shifts and editing the information', () => {
    ...
    test('Editing the Existing Work Shifts Information by filtering', async () => {
        ...
        await adminPage.fillTextBoxValues(adminPage.workShiftsLocators.shiftName, Constants.adminModule.workShifts.shiftNameEdited);
...
test.describe('Modifying Corporate Branding Information and saving the information', () => {
    test('Editing Corporate Branding Color Information and saving', async () => {
        ...
        await adminPage.clickElementWithIndex(adminPage.preview, 0);
        await page.waitForTimeout(3000);
        await adminPage.clickSave(adminPage.publish, 0, Constants.sucessMsg.sucessfulSavedMsg);
    });
